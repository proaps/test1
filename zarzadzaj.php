...
<html>
 ...
 <body>
	<nav>
		<ul>
			<li>
				<a href="http://proaps.gbzl.pl/Lab7/indeks.php">Powrót</a>
			</li>
		</ul>
	</nav>
  <br /><br />
  <div class="container">
   <h2 align="center">Twoje foldery i pliki</a></h2>
   <br />
   <div align="right">
    <button type="button" name="create_folder" id="create_folder" class="btn btn-success">Utwórz folder</button>
   </div>
   <br />
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title"><span id="change_title">Utwórz folder</span></h4>
   </div>
   <div class="modal-body">
    <p>Wpisz nazwę folderu
    <input type="text" name="folder_name" id="folder_name" class="form-control" /></p>
    <br />
    <input type="hidden" name="action" id="action" />
    <input type="hidden" name="old_name" id="old_name" />
    <input type="button" name="folder_button" id="folder_button" class="btn btn-info" value="Utwórz" />
  ...
  <div class="modal-content">
   ...
   <div class="modal-body">
    <form method="post" id="upload_form" enctype='multipart/form-data'>
     ...
     <input type="submit" name="upload_button" class="btn btn-info" value="Wgraj" />
    </form>
   </div>
   <div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal">Zamknij</button>
...
<div id="filelistModal" class="modal fade" role="dialog">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title">Lista plików</h4>
   </div>
...
$(document).ready(function(){
 ...
 $(document).on('click', '#create_folder', function(){
  $('#action').val("create");
  $('#folder_name').val('');
  $('#folder_button').val('Utwórz');
  $('#folderModal').modal('show');
  $('#old_name').val('');
  $('#change_title').text("Utwórz folder");
 });
